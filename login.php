...
<body>
    ...
    <div class="flex justify-center items-center h-[100vh] bg-gray-200 ">
            ...
            <div class="px-8 py-6">
                ...
                <form action="login_db.php" method="post">
                    ...
                    <div class="mt-5">
                        ...
                        <input type="password" name="password" placeholder="••••••••" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 ">
                    </div>
                    <!----------------------------Show password -------------------------------->
                    ...
                    <div class="mt-4">
                        <button type="submit" name="login" class="bg-gray-500 text-white p-2.5 rounded hover:bg-gray-600 w-full text-md">
                            Đăng nhập
                        </button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400 mt-5">
                            Bạn chưa có tài khoản ?
                            <a href="register.php" class=" ms-2 font-medium text-primary-600 hover:underline ">
                                Đăng ký
                            </a>
                        </p>
                    </div>
